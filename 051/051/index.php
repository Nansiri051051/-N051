...
<body class="container mt-4">
    ...
    <div class="row g-4"> 
        <?php foreach ($products as $p): ?>
            <?php
            // แก้ไข: เปลี่ยนพาธเป็น Absolute Path โดยอ้างอิงจาก Root ของ Localhost (สมมติว่าเป็น /051/)
            $img = !empty($p['image'])
            ? '/051/product_images/' . rawurlencode($p['image']) // แก้ไขตรงนี้
            : '/051/product_images/no-image.jpg'; // แก้ไขตรงนี้ด้วย

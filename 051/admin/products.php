...
@unlink($filePath); // ใช้ @ กัน warning ถ้าลบไม่สำเร็จ
}
}
header("Location: products.php"); // แก้ไขการ Redirect ให้ถูกต้อง
exit;
}
...
<head>
    ...
    <style>
        body {
            background: linear-gradient(135deg, #cc0055, #ff006aff);
            background-size: 400% 400%;
            animation: gradient-animation 15s ease infinite;
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            /* ต้องมี min-height: 100vh เพื่อให้การจัดกึ่งกลางแนวตั้งทำงาน */
            min-height: 100vh;
        }
